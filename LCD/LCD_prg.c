...
void LCD_vidSendCommand(uint8_t uint8_tCmdCpy)
{
	...
	/* Set RS to LOW */
	DIO_VidSetPinValue(PORTA, 0, LOW);

	/* Set R/W to LOW */
	DIO_VidSetPinValue(PORTA, 1, LOW);

	/* Set E to HIGH  */
	DIO_VidSetPinValue(PORTA, 2, HIGH);

	/* Load Command on Data bus */
	DIO_VidSetPortValue(PORTD, uint8_tCmdCpy);

	/* Set E to LOW */
	DIO_VidSetPinValue(PORTA, 2, LOW);
...
{
	/* Set RS to HIG */
	DIO_VidSetPinValue(PORTA, 0, HIGH);
	...
	/* Load Command on Data bus */
	DIO_VidSetPortValue(PORTD, uint8_tDataCpy);
